...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        {
            _userService = userService;//initialize ettik
            _tokenHelper = tokenHelper;//initialize ettik
        }
        ...
        public IDataResult<User> Login(UserForLoginDto userForLoginDto)
        {
            ...
            return new SuccessDataResult<User>(userToChack, Messages.SuccesfulLogin);
        }
